 ...
 */
public class AndroidStreamClientImpl implements StreamClient {
    ...
    public AndroidStreamClientImpl(StreamClientConfigurationImpl configuration) throws InitializationException {
