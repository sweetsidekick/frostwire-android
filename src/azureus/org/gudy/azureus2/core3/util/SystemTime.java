...
public class SystemTime {
	...
	static
	{
		try
		{
			...
			{
				instance = new AndroidProvider();// new SteppedProvider();
			}
		} catch (Throwable e)
		{
			// might be in applet...
    ...
    /**
     * High risk time provider. Only using it in android for performance reasons.
     */
    protected static class AndroidProvider implements SystemTimeProvider {
        ...
        private static final int STEPS_PER_SECOND = (int) (1000 / ANDROID_TIME_GRANULARITY_MILLIS);
        private static final long HPC_START = getHighPrecisionCounter() / 1000000L;
                ...
                public void run() {
                    ...
                    while (true) {
                        ...
                        if (delta < 0 || delta > 1000) {
                             ...
                             * second
                             */
                            stepped_time += ANDROID_TIME_GRANULARITY_MILLIS;
                            adjustedTimeOffset = rawTime - stepped_time;
                        ...
                        try {
                            Thread.sleep(ANDROID_TIME_GRANULARITY_MILLIS);
                        } catch (Exception e) {
                            Debug.printStackTrace(e);
                        }
                    }
